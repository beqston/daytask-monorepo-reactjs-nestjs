...
export default function Input({type, htmlFor, placehoolder, text, leftImage, rightImage, onChange, value}:InputType){
    return(
        <div className="mt-2">
            <label htmlFor={htmlFor} className="text-primary-grey-100 flex flex-col relative">
                ...
                <input onChange={onChange} value={value} className=" bg-light-blue-100 p-2 pl-10" type={type} name={htmlFor} placeholder={placehoolder} id={htmlFor} />
                {
